...
-- Move active window (AeroSpace style)
...
-- Resize active window (AeroSpace style)
hl.bind("ALT + minus", hl.dsp.layout("splitratio -0.05"))
hl.bind("ALT + equal", hl.dsp.layout("splitratio +0.05"))

-- Layout orientation (AeroSpace style)
hl.bind("ALT + slash",  hl.dsp.layout("togglesplit"))
...
hl.bind("ALT + I",                  hl.dsp.exec_cmd(launchPrefix .. TERMINAL))
...
-- Brightness (using ddcutil for external AORUS monitor)
