...
-- telescope
remap("n", "<leader>f<leader>", "<cmd>Telescope resume<cr>", bufopts, "Resume telescope")
remap("n", "<leader>F", "<cmd>Telescope current_buffer_fuzzy_find<cr>", bufopts, "Current buffer fuzzy find")
remap("n", "<leader>fF", "<cmd>Telescope git_files<cr>", bufopts, "Find git file")
...
remap("n", "<leader>fl", "<cmd>Telescope oldfiles<cr>", bufopts, "Find oldfiles")
...
remap("n", "<leader><leader>", tree.tree.toggle, bufopts, "Focus nvim-tree")
